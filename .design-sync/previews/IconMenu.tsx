import { Button, Card, IconMenu } from 'frontend'
...
export const Tones = () => (
  <div className="row gap-5" style={{ padding: 'var(--sp-4)' }}>
    ...
    <IconMenu width={28} height={28} style={{ color: 'var(--c-text-muted)' }} />
    <IconMenu width={28} height={28} style={{ color: 'var(--c-accent)' }} />
    <IconMenu width={28} height={28} style={{ color: 'var(--c-positive)' }} />
    <IconMenu width={28} height={28} style={{ color: 'var(--c-negative)' }} />
  </div>
)
