import { Button, Card, IconSearch } from 'frontend'
...
export const Tones = () => (
  <div className="row gap-5" style={{ padding: 'var(--sp-4)' }}>
    ...
    <IconSearch width={28} height={28} style={{ color: 'var(--c-text-muted)' }} />
    <IconSearch width={28} height={28} style={{ color: 'var(--c-accent)' }} />
    <IconSearch width={28} height={28} style={{ color: 'var(--c-positive)' }} />
    <IconSearch width={28} height={28} style={{ color: 'var(--c-negative)' }} />
  </div>
)
