import { Button, Card, IconPlus } from 'frontend'
...
export const Tones = () => (
  <div className="row gap-5" style={{ padding: 'var(--sp-4)' }}>
    ...
    <IconPlus width={28} height={28} style={{ color: 'var(--c-text-muted)' }} />
    <IconPlus width={28} height={28} style={{ color: 'var(--c-accent)' }} />
    <IconPlus width={28} height={28} style={{ color: 'var(--c-positive)' }} />
    <IconPlus width={28} height={28} style={{ color: 'var(--c-negative)' }} />
  </div>
)
...
export const InContext = () => (
  <div className="col gap-3" style={{ padding: 'var(--sp-4)' }}>
    <div className="row gap-3 wrap">
      <Button size="sm">
        <IconPlus width={16} height={16} /> Add company
      </Button>
